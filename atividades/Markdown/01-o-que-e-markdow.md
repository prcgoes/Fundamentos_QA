Atividade Markdown
# Hoje o assunto é sobre QA e Markedown!
Para agilizar o meu trabalho, decidi estudar os dois assuntos e unir isso tudo em um documento só, sera que vai dar bom! 

Vou começar por um asintaxe básica no texto com detalhes em **negrito** e em *itálico*, tamanho:
# Titulo 1
## Título 2
### Título 3
#### Título 4 ...
...
**Tabelas**
**check liste de tarefsa**


## Coisas para fazer hoje:
- [x] Estudar os links sujetidos 
- [x] escrever um documento sobre QA e Markdwon.
- [x] Tomar café ☕
- [x] Salvar isso tudo em arquivo .md
